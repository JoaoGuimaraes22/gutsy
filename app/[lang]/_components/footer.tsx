...
interface FooterDictWithBrand extends FooterDict {
  brand: string;
}

export default function Footer({ dict }: { dict: FooterDictWithBrand }) {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-1.5 text-sm text-zinc-400 leading-relaxed">
