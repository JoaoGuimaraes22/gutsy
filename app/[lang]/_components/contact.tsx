...
interface ContactDictWithExtras extends ContactDict {
  map: ContactMapDict;
  order_url: string;
}

export default function Contact({ dict }: { dict: ContactDictWithExtras }) {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
          <motion.div className="flex flex-col gap-6" {...fadeUp(0.1)}>
            <p className="text-sm leading-relaxed text-zinc-600">{dict.body}</p>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <span className="font-medium">{dict.phone}</span>
              </motion.a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-zinc-400 mt-0.5">{dict.hours}</div>
                </div>
              </motion.a>
            </div>
