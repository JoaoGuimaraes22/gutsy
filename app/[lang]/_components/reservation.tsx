...
export default function Reservation({ dict }: { dict: ReservationDict }) {
        ...
        <div className="p-6 pt-8">
          {status === "success" ? (
            <div className="flex flex-col items-center py-12 text-center">
              ...
              <h2 id="reservation-title" className="mb-2 text-2xl font-bold">{dict.success_title}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <h2 id="reservation-title" className="text-2xl font-bold">{dict.title}</h2>
              ...
              {/* Guests */}
              <div>
                <p className="mb-2 text-sm font-semibold">{dict.guests_label}</p>
                <div className="flex flex-wrap gap-2">
                  {dict.guests_options.map((g) => (
                    <button
                      key={g}
                      type="button"
